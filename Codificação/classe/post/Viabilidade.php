...
require_once '../modelo/usuario/Revisor.php';
...
if(isset($_POST['token'])){
  ...
  if( strcmp( $token, $testeToken) == 0 ){
    ...
    if(!Filtro::verificaCampos( Array($codIdeia, $tipo, $usuario, $justificativa, $link) ) )
      IrPara::link('/index.php?dir=viabilidade&r=2');
    ...
    $revisao->setDocumento($documento);
      ...
      if ($revisao->salvarDocumentoAvaliacao($conexao)) {
        ...
        // objeto ideia
          ...
          IrPara::link('/index.php?dir=viabilidade&r=1');
      } else {
          // voltar para a pagina de ideias pendentesSucesso
          IrPara::link('/index.php?dir=viabilidade&r=0');
      }

...
if (isset($_POST['token'])) {
    if ($_SESSION['token'] == $_POST['token']) {
        ...
        if (strcmp($token, $testeToken) == 0) {
            ...
            $codigo = filter_input(INPUT_POST, 'id', FILTER_VALIDATE_INT);
            ...
            if ($colaborador->editarIdeia($conexao)) {
                IrPara::link('/index.php?dir=ideiasAdmin&sucesso='.$codigo);
            } else {
               IrPara::link('/index.php?dir=ideiasAdmin&err='.$codigo);
            }
